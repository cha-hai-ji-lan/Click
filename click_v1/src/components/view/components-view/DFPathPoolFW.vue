...
<template>
    ...
    <div v-show="FloatingWindow['choose-path-pool']" class="choose-path-pool"
        ...
        <div class="drag-head-contain" @mousedown="startDrag">
            ...
            <div class="tag-icon wire tooltip" data-tooltip="选择文件" @click="() => { openFileDialog() }">
