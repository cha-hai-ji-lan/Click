<template>
    <div class="collect-store-files">
        ...
        <table v-if="selectedValueSon !== ''" class="collect-item">
            <input v-if="selectedValueSon === 'by-name'" name="by-name" class="input-box" type="text"
                @input="updateValueCollectFile" placeholder="名字需要包含的字段">
            <input v-if="selectedValueSon === 'by-time'" name="by-time" class="input-box" type="text"
                @input="updateValueCollectFile" placeholder="时间范围 例如: 2005 03 03到2025-02-20">
            <input v-if="selectedValueSon === 'by-size'" name="by-size" class="input-box" type="text"
                @input="updateValueCollectFile" placeholder="时间范围 例如: 2M到3GB">
        </table>
    </div>
</template>
