<template>
     <div class="main-contain">
          <div class="title">
               ...
               <div class="tag-icon wire tooltip" data-tooltip="路径池" @click="() => { click('choose-path-pool') }">

                    <svg v-if="userSelectedPath && userSelectedPath.length > 0" t="1766718881525" class="icon"
                         viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8409"
                    ...
                    <svg v-else t="1766718881522" class="icon" viewBox="0 0 1024 1024" version="1.1"
                         xmlns="http://www.w3.org/2000/svg" p-id="8409" width="200" height="200">
                         <path d="M483.254857 949.76q16.822857 8.411429 33.718857 8.411429 22.162286 0 39.936-14.189715 33.353143-23.917714 33.353143-61.586285V496.64l234.422857-315.099429q24.868571-33.206857 5.924572-75.849142Q812.909714 65.828571 765.586286 65.828571H154.331429q-47.177143 0-64.950858 39.497143-22.528 40.96 5.851429 78.701715l234.422857 315.172571v332.434286q0 46.08 42.276572 64.950857l111.396571 53.174857zm33.718857 1.097143a55.442286 55.442286 0 0 0 35.547429-12.653714 69.705143 69.705143 0 0 0 30.427428-55.808V494.226286l235.885715-317.074286c15.286857-20.260571 15.286857-45.641143 5.12-68.461714-10.166857-22.893714-32.987429-35.547429-58.368-35.547429H154.331429c-25.380571 0-48.274286 12.653714-58.368 35.547429a65.609143 65.609143 0 0 0 5.12 70.948571l235.885714 317.147429v334.848c0 25.380571 15.213714 48.201143 38.034286 58.368l111.616 53.248c10.166857 5.12 20.333714 7.606857 30.427428 7.606857zm248.685715-816.859429c2.486857 0 4.973714 0 4.973714 2.56 2.56 0 2.56 2.56 0 5.12l-1.462857 2.048-.146286.146286L534.674286 458.752a76.653714 76.653714 0 0 0-12.653715 40.594286v385.536c0 2.56 0 5.12-2.56 5.12h-5.12l-114.102857-53.321143c-2.56 0-2.56-2.486857-2.56-5.12V499.419429a70.217143 70.217143 0 0 0-12.653714-40.594286L149.138286 141.604571v-5.046857c0-2.56 2.56-2.56 5.12-2.56h611.328zm-607.597715 7.314286h603.721143L528.676571 454.656l-.219428.292571q-13.677714 22.893714-13.677714 44.397715v382.683428l-109.714286-51.2V499.346286q0-26.112-14.116572-44.982857l-232.886857-313.051429z"
                              p-id="8411" />
                    </svg>
               </div>
               <div class="tag-icon wire tooltip" data-tooltip="操作栏" @click="() => { click('choose-function') }">
          ...
          <div class="oper">
               <div class="h3-head">
                    ...
                    <h3>操作</h3>
                    <span class="icon-right-margin tooltip" data-tooltip="指南 施工ing🔨">
               ...
               <div v-if="focusMethod === '0'" class="oper-1">
                    <transition name="replace-name-transition" mode="out-in">
                         ...
                         <DFChangeName :active_path="active_path"
                              ...
                              :SubmitRepluceName="SubmitRepluceName"></DFChangeName>
                    </transition>
               </div>
...
const inputRefReplaceOldName = ref("")  // 旧字段
const inputRefReplaceNewName = ref("")  // 新字段
const inputRefSortName = ref("")


const userSelectedPath = ref<string[] | null>(null)  // 用户选择的路径
const userSelectedShortPath = ref<string[] | null>(null)  // 用户选择路径的短名称
...
.choose input[type="checkbox"]:checked::after {
     ...
     height: 0.4vmin;
     border: solid white;
     border-width: 0 0 0.2vmin 0.2vmin;
