...
fn main() {
    let md5 = win_calc_md5(r"D:\Downloads\7za920.zip".to_string());
    match md5 {
        Ok(md5) => println!("MD5: {}", md5),
...
//
// fn main() {
//     download_images("https://www.gorecenter.com/wp-content/uploads/2025/09/Examination-and-autopsy-of-female-victim-of-machete-attack-{num}.jpg".to_string(),
//                     1, 26, r"D:\Downloads\对砍刀袭击女性受害者的检查和尸检".to_string(), 0).unwrap();
// }
//
// /// 异步下载url图片
// #[tokio::main]
