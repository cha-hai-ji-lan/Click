...
fn main() {
    get_php_page_img(
        "https://.com/index.php?route=comic/reader&gk_id=d546O%2Fx2qf49a19Q%2BgUYn2d6SJ%2BWaFL2sy2DEQ7XIENJP%2FfQOoKO7FdZhcDu4OkzWx%2BMQwbXJJSYvMaWdutlf%2BMKEZeyB3Qvcggg1jPGos3ZTKXOhyL1r1LJqaQBnVFLYade6tdbYkM%2FFQ&c_id=f5ebe0ab975ec52c10a96e39e3caa1b2".to_string()
        , 1, 2, "&c_id".to_string(), "&host_id".to_string(), "&gallery_brightness=100&gallery_contrast=100".to_string()).expect("TODO: panic message");
}
